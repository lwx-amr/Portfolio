      ...
      <div className="relative w-auto my-6 mx-auto max-w-xl">
        ...
        <div className="border-0 shadow-lg relative flex flex-col w-full bg-secondary outline-none focus:outline-none z-50 py-8 px-6">
          ...
          <div className="relative py-2 flex-auto">
            <p className="text-primary text-base leading-relaxed pr-12">
          ...
          <form className="mt-6" method="POST">
            <div className="flex items-center justify-between">
              ...
              />
              <button
                className="bg-green-btn  text-gray-100 text-base font-semibold uppercase px-6 pb-2 pt-3 rounded shadow-sm hover:shadow-lg outline-none leading-snug focus:outline-none hover:bg-green-200"
                type="button"
                style={{
