          ...
          <form className="mt-6" method="POST">
            <div className="flex items-center justify-between">
              <input
                ...
                text-gray-100 font-medium appearance-none border border-gray-400 shadow-sm bg-gray-600 placeholder-gray-400 focus:outline-none focus:shadow-outline-blue focus:border-blue-300"
              />
              <button
